...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.اكس او"))
async def _(event):
    bot = 'inlinegamesbot'
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.حجرة ورقة مقص"))
async def _(event):
    bot = 'inlinegamesbot'
    xo = await sedthon.inline_query(bot, "")
    await xo[4].click(
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.سورس"))
async def a(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.تهكير"))
async def a(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.صورته"))
async def _(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.ذاتية"))
async def _(event):
...
@okthon.on(events.NewMessage(pattern=r"\.ادمن", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.انهاء الاسم الوقتي"))
async def _(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.اسم وقتي"))
async def _(event):
    time_name.clear()
    time_name.append("on")
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.انهاء البايو الوقتي"))
async def _(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.بايو وقتي"))
async def _(event):
    await event.delete()
    if event.fwd_from:
        return
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.بايو"))
async def _(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.غادر"))
async def leave(e):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.اذاعة كروب(?: |$)"))
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.اذاعة للخاص(?: |$)(.*)"))
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.تكرار (.*)"))
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.توقف_التكرار$"))
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.مكرر (.*)"))
async def spammer(event):
    global spamming
    if spamming:
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.اشتراكاتي"))
async def _(event):
    if event.fwd_from:
        return
...
@okthon.on(events.NewMessage(pattern=r"\.ملصق عربي", outgoing=True))
async def _(event):
...
@okthon.on(events.NewMessage(pattern=r"\.ملصق", outgoing=True))
async def _(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.الاوامر"))
async def _(event):
    await event.edit(commands)


@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.اوامري"))
async def _(event):
    await event.edit(commands)


@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.اوامر"))
async def _(event):
    await event.edit(commands)
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.فحص"))
async def _(event):
    start = datetime.datetime.now()
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.م2"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec2)


@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.م3"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec3)


@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.م4"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec4)


@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.م5"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec5)


@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.الاوامر الخاصة"))
async def _(event):
    if ispay2[0] == 'yes':
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.التاريخ"))
async def _(event):
    await event.edit(f"""
`-- -- -- -- -- -- -- -- --`
	`الميلادي : {m9zpi}`
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.ايدي"))
async def _(event):
    reply_message = await event.get_reply_message()
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.المطور"))
async def _(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.مطور"))
async def _(event):
    photo = await sedthon.get_profile_photos(DEVS[0])
    await sedthon.send_file(event.chat_id, photo, caption=f'''
    The best !
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.المبرمج"))
async def _(event):
    photo = await sedthon.get_profile_photos(DEVS[0])
    await sedthon.send_file(event.chat_id, photo, caption=f'''
    The best !
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.مبرمج"))
async def _(event):
    photo = await sedthon.get_profile_photos(DEVS[0])
    await sedthon.send_file(event.chat_id, photo, caption=f'''
    The best !
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.البنك"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit("Ok...")
    end = datetime.datetime.now()
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.السنة"))
async def _(event):
    await event.edit(f"""
-- -- -- -- -- -- -- -- --
السنة : {y}
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.الشهر"))
async def _(event):
    await event.edit(f"""
-- -- -- -- -- -- -- -- --
الشهر : {m}
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.قمر"))
async def _(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.قلب"))
async def _(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.مربعات"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
ownerhson_id = 1422171152
@okthon.on(events.NewMessage(outgoing=False, pattern='/start'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('اهلا مطوري ابن بشار - ')


@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.ورود"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.قلوب"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.فك حظر"))
async def _(event):
...
@okthon.on(events.NewMessage(outgoing=True, pattern=r"\.اعادة تشغيل"))
